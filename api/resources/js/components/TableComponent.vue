...
export default {
  ...
  template: `
  <sui-table-row>
    <sui-table-cell verticalAlign="bottom" >{{link.id }}</sui-table-cell>
    <sui-table-cell>{{link.target_url }}</sui-table-cell>
    <sui-table-cell>{{link.resolver_link }}</sui-table-cell>
    </sui-table-row>
  `
};
</script>
