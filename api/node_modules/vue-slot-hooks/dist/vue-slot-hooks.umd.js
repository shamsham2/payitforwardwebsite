(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('vue-inherit-slots')) :
  typeof define === 'function' && define.amd ? define(['exports', 'vue-inherit-slots'], factory) :
  (factory((global.VueSlotHooks = {}),global.VueInheritSlots));
}(this, (function (exports,vueInheritSlots) { 'use strict';
  ...
  var RenderWithSlotHooks = {
    props: Object.assign({}, omit(RenderSlotHooks.props, ['tag', 'slotHookNameResolver']),
      vueInheritSlots.InheritSlots.props,
      {inheritSlots: {
        type: Boolean,
        default: false
      },
    ...
    render: function render(createElement, context) {
      ...
      if (inheritSlots) {
        inheritedSlots = [
          createElement(vueInheritSlots.InheritSlots, {
            scopedSlots: scopedSlots,
            props: pick(context.props, Object.keys(vueInheritSlots.InheritSlots.props))
          })
        ];
      }
  ...
  exports.default = VueSlotHooksPlugin;
  exports.RenderWithSlotHooks = RenderWithSlotHooks;
